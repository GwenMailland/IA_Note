...
export default function Timeline({ notes, onGenerateDoc, searchQuery = '', onNoteUpdated }) {
  return (
      ...
      <div className="space-y-4">
        {notes.map((note, idx) => (
          <div key={note.id} className="relative pl-12">
            ...
            <NoteCard note={note} onGenerateDoc={onGenerateDoc} searchQuery={searchQuery} onNoteUpdated={onNoteUpdated} />
          </div>
        ))}
      </div>
    </div>
